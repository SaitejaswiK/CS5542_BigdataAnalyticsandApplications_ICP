...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("pizza", "chocolate", "Burger", "ice-cream", "fruits", "vegetables", "drinks", "food", "brocoli", "cheese")
  ...
  def main(args: Array[String]) {
    System.setProperty("hadoop.home.dir","C:\\Users\\Koppu\\Downloads\\winutils")
